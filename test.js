const { Chrome, ChromeLinkedIn, ChromeAliexpress, Firefox, FirefoxLinkedIn } = require('./index.js');
...
function launchChromeAliexpress() {
  console.log('Launching Chrome Aliexpress');
  const instance = new ChromeAliexpress({
    stats: statsMock,
    appPath: chromePath,
    url: 'https://www.aliexpress.com/category/100005433/camping-hiking/8.html?g=n'
  });
...
for (let i = 0; i < 1; i++) {
  ...
  promises.push(launchChromeLinkedIn());
